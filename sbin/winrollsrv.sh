...
do_config_network(){
	...
	if [ "$CONFIG_NETWORK_MODE" = "none" ] || [ -z "$CONFIG_NETWORK_MODE" ] ; then
		...
		# åŽŸå…ˆä½¿ç”¨ space ç‚ºåˆ†éš”ç¬¦è™Ÿï¼Œå¾Œæ”¹ç”¨","
...
do_autohostname(){
	...
	# wsname.exe ªº log file ¤£¯à§ï¡A¤£µMµLªk¨ú±o return code
	...
	#2006/4/14 ¤W¤È 12:21:32 : Terminate                 : Exit code 4

	#2006/4/12 ¤U¤È 05:48:22 : Computer is already named NEW-55. - Rename request aborted!
	#2006/4/12 ¤U¤È 05:48:22 : Terminate                 : Exit code 7

	#2006/4/12 ¤U¤È 05:51:06 : Search Key not found in Data File - Rename request aborted!
	#2006/4/12 ¤U¤È 05:51:06 : Terminate                 : Exit code 14

	#2006/4/12 ¤U¤È 05:51:32 : Can't find data file "C:\\cygwin\\drbl-config\\hostssss.conf" - Rename request aborted!
	#2006/4/12 ¤U¤È 05:51:32 : Terminate                 : Exit code 13

	#2006/4/12 ¤U¤È 05:52:44 : Rename Method             : SetComputerNameEx
	#2006/4/12 ¤U¤È 05:52:44 : Rename Successful - reboot required to take effect

	#2006/4/12 ¤U¤È 06:36:07 : New name validity check   : Failed - Rename request aborted!
	#2006/4/12 ¤U¤È 06:36:07 : Terminate                 : Exit code 8
